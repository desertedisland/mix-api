...
export default class MixClient {
    ...
    doSearch(query) {
        ...
        const promises = [this._mixSearch.getBlock(query), this._mixSearch.getBalance(query), this._mixSearch.getTransaction(query)];
    ...
    getSystemStats(latestBlocks = null) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._systemStats.getState().then(state => {

                stats.state = state;

                let promises = [this._systemStats.getPeerCount(), this._systemStats.getGasPrice()];
    ...
    getBlocks() {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._systemStats.getState().then(() => {
                ...
                this._systemStats.getLatestBlocks().then(latestBlocks => {
