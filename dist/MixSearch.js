...
export default class MixSearch {
    ...
    getBlock(hashOrNumber) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._web3.eth.getBlock(hashOrNumber, true, (error, block) => {
    ...
    getTransaction(hash) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._web3.eth.getTransaction(hash, (error, transaction) => {
    ...
    getBalance(accountHash) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._web3.eth.getBalance(accountHash, (error, balance) => {
